...
const updateWasher = async(washer)=>{
	const {brand, rpm, minor_dim, model, hp, major_dim, owner, slots, large, motor_start, uf, work_steps, work_laps, work_wire, start_steps, start_laps, start_wire, voltage, connection, winding_type, observations, id_washer} = washer
	try {
		const query = "UPDATE washers SET brand=$1, rpm=$2, minor_dim=$3, model=$4, hp=$5, major_dim=$6, owner=$7, slots=$8, large=$9, spin_work_steps=$10, spin_work_laps=$11, spin_work_wire=$12, spin_start_steps=$13, spin_start_laps=$14, spin_start_wire=$15, first_wash_work_steps=$16, first_wash_work_laps=$17, first_wash_work_wire=$18, second_wash_work_steps=$19, second_wash_work_laps=$29, second_wash_work_wire=$21, wash_start_steps=$22, wash_start_laps=$23, wash_start_wire=$24, capacity=$25, voltage=$26, connection=$27, winding_type=$28, observations=$29 WHERE id_monophasic=$30"
		const res = await pool.query(query,[brand, rpm, minor_dim, model, hp, major_dim, owner, slots, large, motor_start, uf, work_steps, work_laps, work_wire, start_steps, start_laps, start_wire, voltage, connection, winding_type, observations, id_washer]);
		return res
	} catch (error) {
		return null
	}
