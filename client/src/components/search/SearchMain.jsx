...
const SearchMain = ({form, loading, motors, handleChange, handleReset, setDataToEdit, setMotorToDelete, getMotor})=>{
  ...
  return(
    <div className="d-flex flex-grow-1 overflow-y-auto">
      ...
      <MotorTable motors={motors} setDataToEdit={setDataToEdit} setMotorToDelete={setMotorToDelete}/>
    </div>
  )
}
