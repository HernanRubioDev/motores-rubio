      ...
      <form onSubmit={(e)=>loginUser(e, form)} className="d-flex flex-column align-items-center justify-content-center col-12 col-lg-6 border">
          ...
          <div className="mb-4">
            ...
            <div className="d-flex flex-column align-items-center position-relative">
              ...
              <input onChange={(e)=>handleChange(e)} type="text" className={`${errors && errors.username ? 'is-invalid' : 'is-valid'} login-input form-control`} id="usernameValidation" placeholder='Ingrese su usuario' required autoFocus name='username' value={form.username}/>
          ...
          <div className="mb-3">
            ...
            <div className="d-flex align-items-center position-relative">
              ...
              <input onChange={(e)=>handleChange(e)} type="password" className={`${errors && errors.username ? 'is-invalid' : 'is-valid'} login-input form-control`} placeholder='Ingrese su contraseña' required name='password' value={form.password}/>
