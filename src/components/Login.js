      ...
      <form className="border container-fluid p-3 w-sm-100 col-sm-6 col-md-5 col-lg-4 col-xl-3 bg-white rounded-1">
        ...
        <div className="mb-3 pt-3">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-person" viewBox="0 0 16 16">
            ...
            <input onChange={(e)=>handleChange(e)} type="text" className="form-control ms-2" id="userLogin" placeholder="Usuario" name='username' value={form.username}/>
          </div>
        ...
        <div className="mb-3">
          <div className="d-flex align-items-center">
            ...
            <input onChange={(e)=>handleChange(e)} type="password" className="form-control ms-2" id="passwordLogin" placeholder="Contraseña" name='password' value={form.password}/>
          </div>
