  ...
  return(
    <section className="bg-img d-flex container-fluid justify-content-center align-items-center h-100 w-100 bg-body-secondary">
      ...
      <form className="border container-fluid p-3 w-sm-100 col-sm-7 col-md-6 col-lg-5 col-xl-4 bg-white rounded-1">
        <legend className="text-center w-100 border-bottom pb-3 fs-2 fw-semibold">Registrarse</legend>
        <div className="mb-3 pt-3">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-person" viewBox="0 0 16 16">
            ...
            <input onBlur={(e)=>handleBlur(e)} onChange={(e)=>handleChange(e)} type="text" className="form-control ms-2 fs-5" id="userRegister" autoFocus placeholder="Usuario" name='username' value={form.username} tabIndex='1'/>
          </div>
        ...
        <div className="mb-3">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" className="bi bi-envelope" viewBox="0 0 16 16">
            ...
            <input onBlur={(e)=>handleBlur(e)} onChange={(e)=>handleChange(e)} type="email" className="form-control ms-2 fs-5" id="emailRegister" placeholder="Email" name='email' value={form.email} tabIndex='2'/>
          </div>
        ...
        <div className="mb-3">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-key" viewBox="0 0 16 16">
            ...
            <input onBlur={(e)=>handleBlur(e)} onChange={(e)=>handleChange(e)} type="password" className="form-control ms-2 fs-5" id="passwordRegister" placeholder="Contraseña" name='password' value={form.password} tabIndex='3'/>
          </div>
        ...
        <div className="mb-3">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-key" viewBox="0 0 16 16">
            ...
            <input onBlur={(e)=>handleBlur(e)} onChange={(e)=>handleChange(e)} type="password" className="form-control ms-2 fs-5" id="RePasswordRegister" placeholder="Repite la contraseña" name='rePassword' value={form.rePassword} tabIndex='4'/>
          </div>
            <p id="RePasswordRegister" className="form-text text-danger text-end">{errors.rePassword}</p>
        </div>
        <div className="d-flex flex-column justify-content-evenly align-items-center">
          {Object.keys(errors).length === 0 ?
          <button onClick={()=>registerUser(form, openModal)} type="button" className="btn btn-primary w-100 fs-5 fw-semibold"  tabIndex='5'>Registrarse</button>
          :
          <button type="button" className="btn btn-primary w-100 fs-5 fw-semibold" disabled>Enviar</button>
        }
        {loading ? <Loader /> : ''}
        <div className="form-text text-secondary d-flex justify-content-center w-100 fs-6 mt-2">¿Ya tienes cuenta? <Link className="text-decoration-none text-primary ms-1 fs-6" to='/login'>Ingresa!</Link></div>
        </div>
      </form>
    </section>
  );
